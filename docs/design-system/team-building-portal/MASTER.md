...
> **SoT đã chuyển:** dùng [`docs/design-system/MASTER.md`](../MASTER.md) — file này là output thô của skill (Lexend/hero CTA) và **không** được follow. Override đã khóa: Be Vietnam Pro, không marketing hero, token trạng thái, lucide/shadcn.

> **LOGIC:** When building a specific page, first check `docs/design-system/pages/[page-name].md`.
> If that file exists, its rules **override** `docs/design-system/MASTER.md`.
> If not, strictly follow `docs/design-system/MASTER.md`.

---

**Project:** Team Building Portal
**Generated:** 2026-09-14 22:48:25
